...
function edit_menu(){
    ...
    */
    ...
    $table_redact = str_replace( '{addbbcode20}', $addbbcode20, $table_redact );
    /*....................................table_redact2............................................*/
    $name_content2 = 'content2';
    $helpbox2 = 'helpbox2';
    $i2 = '2';
    $addbbcode21 = '<select name="addbbcode21" onChange="bbfontstyle(\'[color=\' + this.form.addbbcode21.options[this.form.addbbcode21.selectedIndex].value + \']\', \'[/color]\', \''.$i2.'\'); this.selectedIndex=0;" onMouseOver="helpline(\'s\', \''.$i2.'\')" onMouseOut="helpline(\'h\', \''.$i2.'\')">';
    ...
    $table_redact2 = str_replace( '{name_content}', $name_content2, $table_redact2 );
    $table_redact2 = str_replace( '{helpbox}', $helpbox2, $table_redact2 );
    $table_redact2 = str_replace( '{i}', $i2, $table_redact2 );
    $table_redact2 = str_replace( '{addbbcode20}', $addbbcode21, $table_redact2 );
