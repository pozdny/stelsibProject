    ...
    function add_new_input()
    {
        ...
        $('<tr>').attr('class','trinput_'+total)
            ...
            .append($('<td>').css({width:'60px'})
                .append($('<span id="progress_'+total+'" class="padding5px"><a href="#" onclick="$(\'.trinput_'+total+'\').remove();" class="ico_delete"><img src="http://stelsib.ru/img/icons/delete.png" alt="del" border="0"></a></span>')))
            .appendTo('#add_input');
    }
