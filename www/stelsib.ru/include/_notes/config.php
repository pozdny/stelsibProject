...
if (!defined("HOST_NAME")) define ( 'HOST_NAME', 'stelsib.ru' );
if (!defined("DIR_PATH")){
...
define ( 'EDIT_IMG', '<img src="'.DOMEN_LOC.'/img/icons/edit_full.png" title="полное редактирование" />');
define ( 'EDIT_IMG_Q', '<img src="'.DOMEN_LOC.'/img/icons/edit_title.png" title="быстро изменить название позиции по-русски" />');
define ( 'EDIT_IMG_K', '<img src="'.DOMEN_LOC.'/img/icons/edit_key.png" title="изменить метатеги" />');
define ( 'DEL_IMG', '<img src="'.DOMEN_LOC.'/img/icons/delete.png" title="удалить" />');
define ( 'NODATA', '');
...
define ( 'NAVIGATOR',         'pages' );
define ( 'COMPLECT',          'complects' );
